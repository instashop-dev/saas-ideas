...
import { callWithFallback, type OpenRouterCallResult } from '../openrouter/provider.js';
  ...
  const result = await callWithFallback(
    {
      ...
      responseFormat: responseSchema
        ? { type: 'json_object', schema: responseSchema }
        : { type: 'json_object' },
    },
    modelsConfig.primary,
    modelsConfig.fallbacks,
